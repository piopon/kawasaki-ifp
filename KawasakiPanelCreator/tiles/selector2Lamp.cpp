 ...
 */
__fastcall selector2Lamp::selector2Lamp(TComponent *myOwner, tileType typeOfTile) : selector2(myOwner,typeOfTile)
{
	ID = 15;
	type = typeOfTile;
...
//destruktor
//---------------------------------------------------------------------------
__fastcall selector2Lamp::~selector2Lamp()
{
	/************************************
 ...
 * arg: myOwner -
 */
zeroTile* selector2Lamp::createTile(TComponent *myOwner, tileType typeOfTile)
{
	return new selector2Lamp(myOwner,typeOfTile);
}
//---------------------------------------------------------------------------
/* metoda do wyswietlania okienka edycyjnego danego kafelka
 */
zeroTile* selector2Lamp::showEditor(void)
{
 ...
 */
void selector2Lamp::setTileContent(void)
{
	try {
		selector2::setTileContent();
 ...
 */
void selector2Lamp::setTileContent(zeroTile *originalTile)
{
	if (originalTile && originalTile->ClassNameIs("selector2Lamp")) {
 ...
 */
void selector2Lamp::getTileContent(void)
{
	try {
		//pobieramy wyglad kafelka
		selector2::getTileContent();
		//1. tlo
 ...
 */
void selector2Lamp::saveToXML(TXMLDocument *xmlSource, int tileNo)
{
 ...
 */
void selector2Lamp::loadFromXML(TXMLDocument *xmlSource, int tileNo)
{
	//sprawdzamy istnieje zrodlo XML
	if (xmlSource) {
		IXMLNode *nodeRoot, *nodeTile, *nodeParams;
 ...
 * arg: fileName - nazwa pliku do ktorego zapisujemy
 */
AnsiString selector2Lamp::saveToIFP(int tileNo)
{
 ...
 * arg: fileName - nazwa pliku do ktorego zapisujemy
 */
void selector2Lamp::loadFromIFP(String ifpData, int tileNo)
{
